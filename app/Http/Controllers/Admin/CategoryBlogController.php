...
class CategoryBlogController extends Controller
{
    public function index()
    {
        ...
        return view('backend.admin.blog.category_blog.index', compact('configuration', 'category_blogs'));
    }

    public function create()
    {
        $configuration = Configuration::first();
        return view('backend.admin.blog.category_blog.create', compact('configuration'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.admin.blog.category_blog.edit', compact('configuration', 'category_blog'));
    }
