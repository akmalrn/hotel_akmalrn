...
class BlogController extends Controller
{
    public function index()
    {
        ...
        return view('backend.admin.blog.index', compact('configuration', 'blogs'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.admin.blog.create', compact('configuration', 'category_blog'));
    }
    ...
    public function edit($id)
    {
        ...
        $category_blog = CategoryBlog::all();
        return view('backend.admin.blog.edit', compact('configuration', 'blog', 'category_blog'));
    }
